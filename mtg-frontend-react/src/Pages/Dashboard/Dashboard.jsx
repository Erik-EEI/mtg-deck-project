    ...
    return (
        <div id='dashboard-container'>
            ...
            <div id='dashboard-cards-container'>
                ...
                <DashboardCard icon={wizardHatIcon} picture={backgroundPicture} mainText='BUILD DECK' subText='Craft the perfect Magic deck that reflects your unique playstyle.' destinationUrl='/build/new'/>
